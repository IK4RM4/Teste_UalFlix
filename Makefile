...
apply:
	...
	kubectl apply -f k8s/postgres/primary-statefulset.yaml
	...
	kubectl apply -f k8s/video-processor/deployment.yaml
	kubectl apply -f k8s/video-processor/service.yaml
